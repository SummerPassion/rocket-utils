 ...
 * Redis
 * Class Redis
 * @package rocket\redis
 * create_at: 2022-02-25 17:02:35
 * update_at: 2022-02-25 17:02:35
 */
class Redis
{
    private $redis;
     ...
     * 连接属性数组
     * @var array|int[]
     * create_at: 2022-02-25 17:17:50
     * update_at: 2022-02-25 17:17:50
     */
     ...
     * 什么时候重新建立连接
     * @var int|mixed
     * create_at: 2022-02-25 17:17:45
     * update_at: 2022-02-25 17:17:45
     */
     ...
     * 主机
     * @var mixed
     * create_at: 2022-02-25 17:17:30
     * update_at: 2022-02-25 17:17:30
     */
    protected $host;
     ...
     * 端口
     * @var int|mixed
     * create_at: 2022-02-25 17:17:37
     * update_at: 2022-02-25 17:17:37
     */
    protected $port;
    ...
    private function __construct($config, $attr = array())
    {
        ...
        if (!$this->redis->connect($this->host, $this->port, $this->attr['timeout'])) {
    ...
    public function pExpire($key, $expires)
    {
        return $this->redis->pExpire($key, $expires);
    }
